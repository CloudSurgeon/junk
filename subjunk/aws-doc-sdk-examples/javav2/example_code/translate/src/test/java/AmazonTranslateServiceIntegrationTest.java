...
public class AmazonTranslateServiceIntegrationTest {
    ...
    public static void setUp() throws IOException {
       ...
       translateClient = TranslateClient.builder()
        ...
        try (InputStream input = AmazonTranslateServiceIntegrationTest.class.getClassLoader().getResourceAsStream("config.properties")) {
