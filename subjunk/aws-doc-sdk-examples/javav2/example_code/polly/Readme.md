...
You can test the Java code examples for Amazon Polly by running a test file named **AWSPollyTest**. This file uses JUnit 5 to run the JUnit tests and is located in the **src/test/java** folder. For more information, see [https://junit.org/junit5/](https://junit.org/junit5/).
