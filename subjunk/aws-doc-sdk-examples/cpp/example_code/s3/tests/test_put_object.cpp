...
int main()
{
    ...
    Aws::InitAPI(options);
    {
        ...
        {
            std::cout << "Error: PutObject test setup: Create bucket '" <<
                bucket_name << "': " <<
        ...
        {
            std::cout << "Error: PutObject test cleanup: Delete object '" <<
        ...
        {
            std::cout << "Error: PutObject test cleanup: Delete bucket: " <<
