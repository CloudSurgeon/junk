...
export class SetupStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    //
    //    Note that the value of --stack-name must be unique within an
    //    AWS Region and AWS account. You can specify up to 128 characters,
    //    and numbers and hyphens are allowed.
    //
