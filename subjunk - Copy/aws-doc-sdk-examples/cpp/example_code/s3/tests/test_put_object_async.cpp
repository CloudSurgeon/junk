...
int main()
{
    ...
    Aws::InitAPI(options);
    {
        ...
        {
            std::cout << "Error: PutObjectAsync test setup: Create bucket '" <<
                bucket_name << "': " <<
        ...
        if (!AwsDoc::S3::PutObjectAsync(s3_client, bucket_name, file_name, "us-east-1"))
        {
            std::cout << "Error: PutObjectAsync test. To clean up, you must "
        ...
        {
            std::cout << "Error: PutObjectAsync test cleanup: Delete object '" <<
        ...
        {
            std::cout << "Error: PutObjectAsync test cleanup: Delete bucket: " <<
